...
namespace NullDevelopment\Nemesis\Config;

use NullDevelopment\Skeleton\Path\Path;
use NullDevelopment\Skeleton\Path\Psr4Path;
use NullDevelopment\Skeleton\Path\SpecPsr4Path;
use NullDevelopment\Skeleton\Path\TestPsr4Path;
