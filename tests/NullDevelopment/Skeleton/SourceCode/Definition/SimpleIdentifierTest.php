...
/**
 * @covers \NullDevelopment\Skeleton\SourceCode\Definition\SimpleIdentifier
 * @group  todo
 */
class SimpleIdentifierTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->properties        = [];
        $this->simpleIdentifier  = new SimpleIdentifier(
            $this->name,
            $this->parent,
            $this->interfaces,
            $this->traits,
