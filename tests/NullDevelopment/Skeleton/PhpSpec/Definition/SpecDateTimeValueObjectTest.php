...
/**
 * @covers \NullDevelopment\Skeleton\PhpSpec\Definition\SpecDateTimeValueObject
 * @group  unit
 */
class SpecDateTimeValueObjectTest extends TestCase
{
